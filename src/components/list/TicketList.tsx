...
export function TicketList({ projectId, statuses }: Props) {
  ...
  return (
    <div className="flex flex-col h-full gap-4">
      ...
      <div className="flex-1 overflow-auto bg-white dark:bg-gray-900 rounded-2xl border border-slate-200 dark:border-gray-700 shadow-card overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-sm min-w-[640px]">
            <thead>
              <tr className="bg-slate-50 dark:bg-gray-800/60 border-b border-slate-200 dark:border-gray-700 text-left">
                ...
                <tr>
                  <td colSpan={6} className="px-4 py-16 text-center">
                    <div className="flex flex-col items-center gap-3">
                      <div className="w-12 h-12 rounded-full bg-slate-100 dark:bg-gray-800 flex items-center justify-center">
                      ...
                      <div>
                        <p className="text-sm font-medium text-slate-500 dark:text-gray-400">Ticket bulunamadı</p>
                        <p className="text-xs text-slate-400 dark:text-gray-500 mt-0.5">Filtrelerinizi değiştirmeyi deneyin</p>
                      </div>
                    </div>
                  </td>
                </tr>
                ...
                tickets?.map((ticket) => {
                  ...
                  return (
                    <tr
                      ...
                      className="hover:bg-primary-50/40 dark:hover:bg-primary-950/15 cursor-pointer transition-colors group"
                    >
                      ...
                      <td className="px-4 py-3.5">
                        {status ? (
                          <span
                            className="inline-flex items-center gap-1.5 text-xs px-2 py-1 rounded-lg font-semibold"
                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex -space-x-1.5">
                          ...
                          {assignees.length > 3 && (
                            <div className="w-6 h-6 rounded-full bg-slate-200 dark:bg-gray-700 ring-1 ring-white dark:ring-gray-900 flex items-center justify-center text-[10px] text-slate-500 dark:text-gray-400 font-medium">
                              +{assignees.length - 3}
                            </div>
                          )}
                        </div>
