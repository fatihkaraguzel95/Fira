        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800/60 text-left">
              <th className="px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide">{t('ticket.columns.title')}</th>
              <th className="px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide w-36">{t('ticket.columns.status')}</th>
              <th className="px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide w-28">{t('ticket.columns.priority')}</th>
              <th className="px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide w-36">{t('ticket.columns.assignees')}</th>
              <th className="px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide w-28">{t('ticket.columns.dueDate')}</th>
              <th className="px-4 py-3 font-semibold text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wide w-28">{t('ticket.columns.createdAt')}</th>
            </tr>
          </thead>
          <tbody>
            {isLoading ? (
