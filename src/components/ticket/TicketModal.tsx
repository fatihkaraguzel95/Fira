...
export function TicketModal({ projectId }: Props) {
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-900 sm:rounded-2xl rounded-t-2xl shadow-2xl flex flex-col w-full sm:w-[95vw] sm:max-w-[1400px] h-[92dvh] sm:h-[94vh]">
        {/* Header */}
        <div className="flex items-start justify-between px-4 md:px-7 py-3 md:py-4 border-b border-gray-100 dark:border-gray-800 gap-4 flex-shrink-0">
          {isLoading ? (
        ...
        {isLoading ? (
          ...
          <div className="flex-1 min-h-0 flex flex-col md:flex-row">
            {/* Main */}
            <div className="flex-1 overflow-y-auto p-4 md:p-7 space-y-5 md:space-y-7 md:border-r border-b md:border-b-0 border-gray-100 dark:border-gray-800 scrollbar-thin">
              {/* Tags */}
              {projectId && (
                <div>
            ...
            {/* Sidebar */}
            <div className="w-full md:w-72 md:flex-shrink-0 overflow-y-auto p-4 md:p-6 space-y-4 md:space-y-6 scrollbar-thin">
              {/* Status */}
              <div>
